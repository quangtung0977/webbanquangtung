...
function CollectParam() {
    var u = $(".manufacture label.check"),
        t, i, r, n, f, e;
    u.length > 0 ? (n = [], $(u).each(function () {
        n.push($(this).data("id"))
    }), advanceQuery.Manufacture = n.join()) : advanceQuery.Manufacture = "";
    (query.categoryID == 42 || query.categoryID == 522) && (advanceQuery.Manufacture = query.Manufacture);
    t = $(".feature .property label.check");
    t.length > 0 ? (n = [], $(t).each(function () {
        n.push($(this).data("id"))
    }), advanceQuery.Property = n.join()) : advanceQuery.Property = "";
    i = $(".feature .yesno label.check");
    i.length > 0 ? (n = [], $(i).each(function () {
        n.push($(this).data("id"))
    }), advanceQuery.Feature = n.join()) : advanceQuery.Feature = "";
    r = $(".barpage label.check");
    r.length > 0 ? (n = [], $(r).each(function () {
        n.push($(this).data("id"))
    }), advanceQuery.Others = n.join()) : advanceQuery.Others = "";
    f = $(".filter li .listprice label.check").data("id");
    e = $(".filter li .sortprice label.check").data("id");
    advanceQuery.PriceRange = f;
    advanceQuery.OrderBy = e;
...
//                t && $(this).scrollTop() + $(window).height() > $(".laptopnews").position().top - 50 && ($(".laptopnews iframe").attr("src", $(".laptopnews iframe").data("src")), t = !1)
//            });
//            break;
//        case 522:
...
//            break;
//        case 7077:
//            $("nav a.smartwatch").addClass("actmenu")
//    }
...
//        }, 600)
//    });
//    $(".criteriaLaptop").click(function () {
//        $(".criteriaLaptop").not(this).next().hide();
//        $(this).next().slideToggle(200);
//        $("body,html").animate({
//            scrollTop: $(".barpageLaptop").position().top
//        }, 600)
//    });
...
//        return $(this).toggleClass("check"), CountAdvance(".feature"), $(this).attr("data-pro") === "18799" && (FL_LoadMore = !0, ShowResult(), $(this).find("a.prevent").length === 1) ? !1 : void 0
//    });
