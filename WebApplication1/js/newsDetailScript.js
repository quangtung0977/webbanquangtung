...
function OpenLoginWindowCampaign(n) {
    var r = host + rootUrl + "/auth?socialType=" + n,
...
function ShowVerifyPhoneNumberCampaign() {
    $.ajax({
        url: rootUrl + "/Auth/VerifyPhoneNumber",
        type: "POST",
        data: {},
        beforeSend: function () {
            $("#dlding").show()
        ...
        success: function (n) {
            $("#dlding").fadeOut();
            AddColorBox("#crazypopup.login", "#lcrazypopuplogin", n)
        }
    })
}

function NotUseOldPhoneNumberCampaign() {
    $("#crazypopup .head .ctn").remove();
    $("#crazypopup .yesno").replaceWith('<form id="frmVerifyPhoneNumber" onsubmit="return GetVerifyCodeCampaign($(this))"><b>Nháº­p sá»‘ Ä‘iá»‡n thoáº¡i báº¡n Ä‘ang dĂ¹ng<\/b><input type="text" id="txtPhoneNumber" name="txtPhoneNumber" placeholder="Sá»‘ Ä‘iá»‡n thoáº¡i cá»§a báº¡n lĂ ..." /><br><button class="btn green">Láº¤Y MĂƒ XĂC NHáº¬N<\/button><\/form>')
}

function GetVerifyCodeCampaign(n) {
    if (FLAG_GETVERIFYCODECampaign) {
        FLAG_GETVERIFYCODECampaign = !1;
        var t = GetAllFormData(n);
        return $.ajax({
            type: "POST",
            cache: !1,
            beforeSend: function () {
            ...
            data: t,
            url: rootUrl + "/Auth/GetVerifyCode",
            success: function (n) {
                var t, i;
                if ($("#dlding").fadeOut(), FLAG_GETVERIFYCODECampaign = !0, n == null || n == "") return alert("KhĂ´ng thá»ƒ xĂ¡c thá»±c thĂ´ng tin, vui lĂ²ng thá»­ láº¡i sau"), !1;
                if (n.status == -1) return alert(n.error), !1;
                t = $("#txtPhoneNumber").val();
                $("#phoneNumber").html(t);
                i = '<form id="frmVerifyPhoneNumber" onsubmit="return SubmitVerifyCodeCampaign($(this))"><b>Nháº­p mĂ£ xĂ¡c nháº­n cá»§a báº¡n<\/b><input type="text" id="txtCode" name="txtCode" placeholder="MĂ£ xĂ¡c nháº­n" /><br><button class="btn green">XĂC NHáº¬N<\/button><a id="resendVerifyCode" class="hide" href="javascript:ResendVerifyCode(\'' + t + "')\">Gá»­i láº¡i mĂ£ xĂ¡c nháº­n<\/a><\/form>";
                setTimeout(function () {
                    $("#resendVerifyCode").removeClass("hide")
                }, 3e4);
                $("#frmVerifyPhoneNumber").replaceWith(i)
            }
        }), !1
    }
}

function SubmitVerifyCodeCampaign(n) {
    if (FLAG_SUBMITVERIFYCODECampaign) {
        FLAG_SUBMITVERIFYCODECampaign = !1;
        var t = GetAllFormData(n);
        return $.ajax({
            type: "POST",
            cache: !1,
            ...
            data: t,
            url: rootUrl + "/Auth/SubmitVerifyCode",
            success: function (n) {
                if ($("#dlding").fadeOut(), FLAG_SUBMITVERIFYCODECampaign = !0, n == null || n == "") return alert("KhĂ´ng thá»ƒ xĂ¡c thá»±c thĂ´ng tin, vui lĂ²ng thá»­ láº¡i sau"), !1;
                if (n.status == -1) return alert(n.error), !1;
                alert("ChĂºc má»«ng, báº¡n Ä‘Ă£ xĂ¡c thá»±c sá»‘ Ä‘iá»‡n thoáº¡i thĂ nh cĂ´ng!");
                location.reload()
            }
        }), !1
    }
...
function UseOldPhoneNumberCampaign() {
    FLAG_USEOLDPHONENUMBERCampaign && (FLAG_USEOLDPHONENUMBERCampaign = !1, $.ajax({
        type: "POST",
        cache: !1,
        beforeSend: function () {
            $("#dlding").show()
        ...
        data: {},
        url: rootUrl + "/Auth/SubmitOldPhoneNumber",
        success: function (n) {
            if ($("#dlding").fadeOut(), FLAG_USEOLDPHONENUMBERCampaign = !0, n == null || n == "") return alert("KhĂ´ng thá»ƒ xĂ¡c thá»±c thĂ´ng tin, vui lĂ²ng thá»­ láº¡i sau"), !1;
            if (n.status == -1) return alert(n.error), !1;
            if (n.status == -2) {
                $("#crazypopup .head .ctn").remove();
                $("#crazypopup .yesno").replaceWith('<p>Ráº¥t tiáº¿c, sá»‘ Ä‘iá»‡n thoáº¡i báº¡n dĂ¹ng cho chÆ°Æ¡ng trĂ¬nh trÆ°á»›c Ä‘Ă£ Ä‘Æ°á»£c ngÆ°á»i khĂ¡c sá»­ dá»¥ng. Vui lĂ²ng kiá»ƒm tra láº¡i hoáº·c xĂ¡c nháº­n sá»‘ Ä‘iá»‡n thoáº¡i má»›i á»Ÿ bĂªn dÆ°á»›i<\/p><form id="frmVerifyPhoneNumber" onsubmit="return GetVerifyCodeCampaign($(this))"><b>Nháº­p sá»‘ Ä‘iá»‡n thoáº¡i báº¡n Ä‘ang dĂ¹ng<\/b><input type="text" id="txtPhoneNumber" name="txtPhoneNumber" placeholder="Sá»‘ Ä‘iá»‡n thoáº¡i cá»§a báº¡n lĂ ..." /><br><button class="btn green">Láº¤Y MĂƒ XĂC NHáº¬N<\/button><\/form>');
                return
            }
            alert("ChĂºc má»«ng, báº¡n Ä‘Ă£ xĂ¡c thá»±c sá»‘ Ä‘iá»‡n thoáº¡i thĂ nh cĂ´ng!");
            location.reload()
...
function ResendVerifyCode(n) {
    flagResendVerifyCode || (flagResendVerifyCode = !0, $("#resendVerifyCode").removeAttr("href").html("Äang gá»­i láº¡i mĂ£ xĂ¡c nháº­n..."), $.ajax({
        url: rootUrl + "/Auth/ResendVerifyCode",
        type: "POST",
        data: {
            phoneNumber: n
        },
        ...
        success: function (n) {
            if (flagResendVerifyCode = !1, $("#ajaxloading").fadeOut(), n.status == -1) {
                alert(n.error);
                return
            }
            $("#resendVerifyCode").html("ÄĂ£ gá»­i láº¡i mĂ£ xĂ¡c nháº­n.")
        }
    }))
}
...
function uslogout() {
    ...
    Delete_Cookie("tgdd_email", "/", n);
    Delete_Cookie("tgdd_fullname", "/", n);
    Delete_Cookie("tgdd_gender", "/", n);
    Delete_Cookie("tgdd_social", "/", n);
    $.ajax({
        url: rootUrl + "/Auth/Logout",
        type: "POST",
        beforeSend: function () {
...
function LoadAvatarImage() {
    setTimeout(function () {
        $(".userdetail a img").attr("src", $(".userdetail a img").data("src"))
    }, 3e3)
}
...
function LoadNewsGame() {
    setTimeout(function () {
        $.ajax({
            ...
            url: "/tin-tuc/aj/Detail/SearchGame",
            success: function (n) {
                n != null && $(".ifrS8").html(n)
            }
        })
...
function initLazy() {
    $("article .imgwrap img.lazy").each(function () {
        $(this).parent().append('<b class="loader"><\/b>')
    });
    $("img.lazy").lazyload({
        effect: "fadeIn",
        load: function () {
            $(this).parent().find("b.loader").remove();
...
function repqmerce() {
    if (!isqmerce) {
        try {
            $("div[id^=idQmerce]").each(function () {
                $(this).html('<iframe allowfullscreen="" name="qmerce" frameborder="0" height="' + $(this).attr("height-data") + '" scrolling="no" src="' + $(this).attr("src") + '" width="100%"><\/iframe>')
            });
            var n = document.createElement("script"),
                t = document.getElementsByTagName("script")[0];
            n.src = "/tin-tuc/Scripts/desktop/apester-sdk.min.js";
            n.async = !0;
...
function reloadlazy() {
    islazynews || (islazynews = !0, $("article .youtube img").each(function () {
        $(this).attr("style", $(this).attr("back-original"));
        $(this).removeAttr("back-original");
        $(this).attr("src", "");
        console.log("...")
    }))
}
...
function LoadJsComment() {
    if (typeof jsCommentUrl != "undefined" && flsc != !0 && typeof cmtaddcommentclick == "undefined") {
        flsc = !0;
        var n = document.createElement("script");
        n.type = "text/javascript";
        n.async = !0;
...
function initSlidePS() {
    $(".collection li").click(function () {
        var n = $(this).parent().attr("data-album"),
            t = $(this).index();
        getSlide(n, t)
    })
}

function getSlide(n, t) {
    var i = {
        newsid: gl_newsid,
        albumid: n
    };
    $.ajax({
        ...
        cache: !1,
        data: i,
        url: "/tin-tuc/aj/Detail/GallerySlide",
        success: function (n) {
            $(".slidePS").html(n);
            initSlide(t)
        }
...
function initSlide(n) {
    var t, e, o, r;
    if (gl_lPS) {
        var s = $("#sl_Width").attr("data-value"),
            h = $("#sl_Height").attr("data-value"),
            i = $("#sl_Img").attr("data-value"),
            c = $("#sl_Desc").attr("data-value");
        if (i != null && i != "") {
            var u = i.split(";"),
                l = s.split(";"),
                a = h.split(";"),
                v = c.split("â•¬"),
                f = [],
                y = document.querySelectorAll(".pswp")[0];
            for (t = 0; t < u.length; t++) e = {
                src: u[t],
                w: l[t],
                h: a[t],
                title: v[t]
            ...
            r = new PhotoSwipe(y, PhotoSwipeUI_Default, f, o);
            r.init();
            n > 0 && (n = n, r.goTo(n))
        }
    } else $.getScript("/tin-tuc/Scripts/common/photoswipe.min.js").done(function () {
        $.getScript("/tin-tuc/Scripts/common/photoswipe-ui-default.min.js").done(function () {
            gl_lPS = !0;
            initSlide(n)
        })
    })
...
function detailLoadCompare() {
    setTimeout(function () {
        $.getScript("/tin-tuc/Scripts/common/jquery.twentytwenty.min.js").done(function () {
            $.getScript("/tin-tuc/Scripts/common/jquery.event.move.min.js").done(function () {
                $(".imgCpr").each(function () {
                    var n = $(this).attr("id");
                    $(this).find("img:first").attr("src", $(this).find("img:first").attr("data"));
                    $(this).find("img:last").attr("src", $(this).find("img:last").attr("data"))
                });
                setTimeout(function () {
                    $(".imgCpr").each(function () {
                        var u = $(this).attr("id");
                        $("#" + u).twentytwenty();
                        var t = $(this).find("img:first").width(),
                            i = $(this).find("img:first").height(),
                            r = .5,
                            n = {
                                w: t + "px",
                                h: i + "px",
                        ...
                        $(this).find(".twentytwenty-handle").css("left", n.cw);
                        $(this).find("img:first").css("clip", "rect(0," + n.cw + "," + n.h + ",0)");
                        $(this).css("height", n.h);
                        $(this).css("width", n.w);
                        $(this).parent().css("width", n.w)
                    })
                }, 1e3)
            })
        })
...
function youtubeview(n, t, i, r) {
    $(n).html('<iframe allowfullscreen="" frameborder="0" height="' + r + '" scrolling="no" src="' + t + '" width="' + i + '"><\/iframe>')
}
...
function tracknewsview() {
    setTimeout(function () {
        ...
        $.ajax({
            ...
            cache: !1,
            data: n,
            url: "/tin-tuc/aj/Detail/TrackNewsView",
            success: function () { }
        })
    }, 6e3)
}

function LoadIframe(n, t, i, r, u) {
    var f = "";
    f = r == 1 ? "<script id='" + t + "' src='" + i + "' type='text/javascript'><\/script>" : "<div class='iframe'><b class='loader'><\/b><iframe allowfullscreen='' frameborder='0' scrolling='no' src='" + i + "' width='100%' height='" + u + "' onload='RemoveIconLoad()'><\/iframe><\/div>";
    $(n).replaceWith(f)
}

function RemoveIconLoad() {
    $("div.iframe").find("b.loader").remove()
}

function NhanThongTin(n) {
    $(n).replaceWith('<input type="text" id="idMail" placeholder="Nháº­p email cá»§a báº¡n"><button type="submit" onclick=\'NhanEmail(this)\'>HoĂ n táº¥t<\/button><button class=\'error\'>Nháº­p email sai!<\/button>')
}
...
function NhanEmail() {
    var n = $("input#idMail").val();
    isValidEmailAddress(n) ? $("button.error").css("display", "none") : $("button.error").css("display", "block")
}

function ShowFrmFebck(n) {
    var t = $("#frmUnsatf").data("value");
    switch (t) {
        case 0:
            $(n).attr("class", "mclk1");
            $("#frmUnsatf").attr("class", "contact");
            $("#frmUnsatf").data("value", 1);
            break;
        case 1:
            $("#frmUnsatf").attr("class", "hide");
            $("#frmUnsatf").data("value", 2);
            break;
        case 2:
            $(n).attr("class", "messenger");
            $("#frmUnsatf").data("value", 0);
            break;
        default:
            $(n).attr("class", "messenger");
            $("#frmUnsatf").attr("class", "hide")
...
function SendFebck() {
    var e = $("#frmUnsatf [name=txtNewsId]").val(),
        r = $("#frmUnsatf [name=txtContent]").val(),
        u = $("#frmUnsatf [name=txtSex]").val(),
        n = $("#frmUnsatf [name=txtFullName]").val(),
        t = $("#frmUnsatf [name=txtPhoneNumber]").val(),
        i = $("#frmUnsatf [name=txtEmail]").val(),
        o = "https://www.thegioididong.com" + window.location.pathname,
        f;
    return r == "" ? ($("#frmUnsatf #alert").attr("class", "alert"), $("#frmUnsatf #alert").attr("style", "display: inline-block"), $("#frmUnsatf #alert").html("Vui lĂ²ng nháº­p ná»™i dung gĂ³p Ă½."), !1) : t != "" && (t.length < 10 || t.length >= 12 || isNaN(t)) ? ($("#frmUnsatf #alert").attr("class", "alert"), $("#frmUnsatf #alert").attr("style", "display: inline-block"), $("#frmUnsatf #alert").html("Lá»—i: Sá»‘ Ä‘iá»‡n thoáº¡i khĂ´ng há»£p lá»‡"), !1) : i != "" && !isValidEmailAddress(i) ? ($("#frmUnsatf #alert").attr("class", "alert"), $("#frmUnsatf #alert").attr("style", "display: inline-block"), $("#frmUnsatf #alert").html("Lá»—i: email khĂ´ng há»£p lá»‡"), !1) : (f = {
        NewsId: e,
        Content: r,
        Sex: u,
        Name: n,
        ...
        cache: !1,
        data: f,
        url: "/tin-tuc/aj/Detail/SendFeedBack",
        success: function (t) {
            if (t > 0) {
                document.getElementById("frmUnsatf").reset();
                var i = "";
                n != "" ? (n = u == "1" ? "anh " + n : "chá»‹ " + n, i = "Cáº£m Æ¡n <span>" + n + "<\/span> Ä‘Ă£ gá»­i gĂ³p Ă½") : i = "Cáº£m Æ¡n báº¡n Ä‘Ă£ gá»­i gĂ³p Ă½";
                $("#frmUnsatf #alert").attr("class", "success");
                $("#frmUnsatf #alert").attr("style", "display: inline-block");
                $("#frmUnsatf .success").html(i);
                doneSentRq()
            } else $("#frmUnsatf #alert").attr("class", "alert"), $("#frmUnsatf #alert").attr("style", "display: inline-block"), $("#frmUnsatf #alert").html("Lá»—i")
        }
    }), !1)
}

function doneSentRq() {
    alert("CĂ¡m Æ¡n báº¡n Ä‘Ă£ gĂ³p Ă½ cho bĂ i viáº¿t");
    document.getElementById("frmUnsatf").reset();
    $("#frmUnsatf").addClass("hide");
    $(".likewied>a").removeClass("mclk1").addClass("messenger")
}

function changeSex(n) {
    $(".contact label.choosed").removeClass("choosed");
    $(n).toggleClass("choosed");
    var t = $(n).data("sex");
    $("#frmUnsatf input[name=txtSex]").val(t)
}

function load4gGameUser() {
    $.ajax({
        type: "GET",
        cache: !1,
        url: "/viettel-4g/Home/Gettotaluser",
        success: function (n) {
            n != null && ($("#totalUser").html(n.totalUser), $("#totalUserWin").html(n.totalWin))
        }
    })
}
var hostName, host, FLAG_GETVERIFYCODECampaign, FLAG_SUBMITVERIFYCODECampaign, FLAG_USEOLDPHONENUMBERCampaign, flagResendVerifyCode, isqmerce, islazynews, flsc, gl_lPS;
(function (n, t) {
    function gt(n) {
        var t = n.length,
            r = i.type(n);
            ...
            var at, rt, gt, ft, ni, ti, ii, et, ot, st, lt, kt, vt, dt, ei = /^img$/i,
                ...
                ri = function () {
                    ...
                    if ((ft = i.loadMode) && k < 8 && (y = u.length)) {
                        for (n = 0, d++ , null == vt && (("expand" in i) || (i.expand = f.clientHeight > 500 && f.clientWidth > 500 ? 500 : 370), kt = i.expand, vt = kt * i.expFactor), yt < vt && k < 1 && d > 2 && ft > 2 && !t.hidden ? (yt = vt, d = 0) : yt = ft > 1 && d > 1 && k < 6 ? kt : hi; n < y; n++)
                            if (u[n] && !u[n]._lazyRace)
                                if (si)
                                    if ((l = u[n][r]("data-expand")) && (e = 1 * l) || (e = yt), p !== e && (ti = innerWidth + e * dt, ii = innerHeight + e, v = -1 * e, p = e), o = u[n].getBoundingClientRect(), (lt = o.bottom) >= v && (et = o.top) <= ii && (st = o.right) >= v * dt && (ot = o.left) <= ti && (lt || st || ot || et) && (i.loadHidden || "hidden" != h(u[n], "visibility")) && (rt && k < 3 && !l && (ft < 3 || d < 4) || ci(u[n], e))) {
                                        if (wt(u[n]), a = !0, k > 9) break
                                    } else !a && rt && !s && k < 4 && d < 4 && ft > 2 && (at[0] || i.preloadAfterLoad) && (at[0] || !l && (lt || st || ot || et || "auto" != u[n][r](i.sizesAttr))) && (s = at[0] || u[n]);
                                else wt(u[n]);
                        s && !a && wt(s)
                    }
                },
...
host = (hostName.indexOf("www.thegioididong.com") > -1 ? "https://" : "http://") + hostName;
FLAG_GETVERIFYCODECampaign = !0;
FLAG_SUBMITVERIFYCODECampaign = !0;
FLAG_USEOLDPHONENUMBERCampaign = !0;
flagResendVerifyCode = !1;
...
$(document).scroll(function () {
    ...
    $("a.iframe").each(function () {
        n > $(this).offset().top - 500 && $(this).click()
    })
});
isqmerce = !1;
islazynews = !1;
...
$(".morepro").click(function () {
    $(this).parent().find("ul li.hidepro").removeClass("hidepro");
    reloadlazy();
    initLazy();
    $(this).remove()
});